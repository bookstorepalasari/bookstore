...
<div class="page-container">	
	<div class="sidebar-menu">
		<header class="logo-env">
			...
			<div class="logo">
				<a href="<?php echo Yii::app()->request->baseUrl; ?>">
					<img src="<?php echo Yii::app()->request->baseUrl; ?>/data/images/logo/logo.png" width="140" alt="" />
				</a>
			</div>
		...
		<ul id="main-menu">
			...
			?>
				<li class="<?php echo ($index==$this->accordionIndex[0])?'active opened active':''; ?>">
					<a href="<?php ($arrMenu['label'] == 'dashboard') ? $this->createUrl($arrMenu['url']) : "#"; ?>">
					...
					<ul>
						<?php foreach ($arrMenu['sub'] as $i => $arr) { ?>
							<li class="<?php echo ($i==$this->accordionIndex[1])?'active':''; ?>">
...
<ol class="breadcrumb bc-3">
	...
	<?php if($this->menu_head != ''){ ?>
		<li>
			<a href="#"><?php echo ucwords($this->menu_head); ?></a>
		</li>
...
<!-- Footer -->
<footer class="main">
	<center><strong>BOOK STORE - PALASARI </strong>&copy; 2017 </center>
</footer>	
